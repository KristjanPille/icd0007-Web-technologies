...
<div class="wrapper">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <div id="error-block" class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
            ...
            <span id="error-block" class="help-block"><?php echo $username_err; ?></span>
        </div>
        <div id="error-block" class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
            <label><?php echo $password;?></label>
            <input type="password" name="password" class="form-control" value="<?php echo isset($_POST['password']) ? $_POST['password'] : '' ?>">
            <span id="error-block" class="help-block"><?php echo $password_err; ?></span>
        </div>
        <div class="form-group">
            <input name="loginButton" type="submit" class="btn btn-primary" value="<?php echo $login;?>">
        </div>
    </form>
</div>
</body>
